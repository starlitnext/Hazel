...
namespace Hazel {
	...
	static void SerializeEntity(YAML::Emitter& out, Entity entity)
	{
		...
		if (entity.HasComponent<CameraComponent>())
		{
			...
			out << YAML::Key << "PrespectiveFov" << YAML::Value << camera.GetPerspectiveFov();
			out << YAML::Key << "PrespectiveNear" << YAML::Value << camera.GetPerspectiveNearClip();
			out << YAML::Key << "PrespectiveFar" << YAML::Value << camera.GetPerspectiveFarClip();
			...
			for (auto entity : entities)
			{
				...
				if (cameraComponent)
				{
					...
					if (cameraNode)
					{
						...
						cc.Camera.SetPerspectiveFov(cameraNode["PrespectiveFov"].as<float>());
						cc.Camera.SetPerspectiveNearClip(cameraNode["PrespectiveNear"].as<float>());
						cc.Camera.SetPerspectiveFarClip(cameraNode["PrespectiveFar"].as<float>());
